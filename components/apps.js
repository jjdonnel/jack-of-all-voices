        ...
        main.innerHTML = `
            ...
            <div id="rhody-weather" class="genre-card glass-card">
                <div class="card-header">
                    <img src="images/rhodyWeatherIcon.png" alt="RhodyWeather Logo" class="app-logo">
            ...
            <div id="rhody-calcs" class="genre-card glass-card">
                <div class="card-header">
                    <img src="images/icon-512.png" alt="RhodyCalcs Logo" class="app-logo">
                    <div class="card-title-group">
                        <h3>RhodyCalcs</h3>
            ...
            <div id="vo-teleprompter" class="genre-card glass-card">
                <div class="card-header">
                    <img src="images/icon.svg" alt="VO Teleprompter Logo" class="app-logo">
                    <div class="card-title-group">
